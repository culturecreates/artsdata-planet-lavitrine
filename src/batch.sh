#!/bin/bash
# Call the Ruby script with arguments
bundle exec ruby lavitrine_pipeline.rb http://kg.artsdata.ca/culture-creates/artsdata-planet-gtq/derived-grandtheatre-qc-ca
bundle exec ruby lavitrine_pipeline.rb http://kg.artsdata.ca/culture-creates/footlight/placedesarts-com
